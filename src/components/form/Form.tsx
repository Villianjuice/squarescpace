...
export const Form = () => {
  ...
  return (
    <form className="form" onSubmit={handleSubmit(onSubmit)}>
      ...
      <label className='form__label'>
        Adress
        <input className='form__input' {...register("address", {
          required: 'Please fill out all required fields',
        })}  />
      </label>
      ...
      <label className='form__label'>
        Индекс - Postal
        <input className='form__input' {...register("postal", {
          required: 'Please fill out all required fields',
        })}  />
      </label>
      <ErrorMessage obj={errors.postal}/>

      <p className="form__info">Subtotal:62 700RUB</p>
      <p className="form__info">Международная доставка — Worldwide Shipping:1 700RUB</p>

      <p className="cartList__total">Total: 64 400RUB</p>
