  ...
  return (
    <div className="desc">
      ...
      <p className="desc__text">
        Снаружи на каждой грани выдавлены буквы из логотипа GGLOOSH, внутри
        полностью логотип, чтобы не забыть, чье кольцо на руке
      </p>
      <p className="desc__text">
        Цвет: Silver Вес от 5,1гр (15 размер) до 17,2гр (22 размер) В комплекте
        брендированная полировочная салфетка для ювелирных изделий Для доставки
        по миру — оформить заказ здесь
      </p>
      <p className="desc__text">
