  ...
  return (
    <div className="cartItem">
      <div className="cartItem__img">
        <img src="https://thumb.tildacdn.com/tild6232-3664-4332-b133-363464663638/-/resize/260x/-/format/webp/image.png" alt="" />
      </div>
      <div className="cartItem__about">
        <Link to='/' className="cartItem__title">EARRING SIX FACES SCREW</Link>
